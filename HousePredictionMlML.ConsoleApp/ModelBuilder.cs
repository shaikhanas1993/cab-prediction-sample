...
namespace HousePredictionMlML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\shaik\Downloads\taxi-fare-train.csv.txt";
        private static string MODEL_FILEPATH = @"C:\Users\shaik\AppData\Local\Temp\MLVSTools\HousePredictionMlML\HousePredictionMlML.Model\MLModel.zip";
